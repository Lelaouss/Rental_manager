...
CREATE TABLE county
(
    id_county  Int Auto_increment NOT NULL,
    id_country Int                NOT NULL,
    name       Varchar(255)       NOT NULL,
    code       Varchar(3)         NOT NULL,
    active     TinyINT            NOT NULL,
    CONSTRAINT county_PK PRIMARY KEY (id_county),
    CONSTRAINT county_country_FK FOREIGN KEY (id_country) REFERENCES country (id_country)
) ENGINE = InnoDB;
...
(
    ...
    CONSTRAINT city_county_FK FOREIGN KEY (id_county) REFERENCES county (id_county)
) ENGINE = InnoDB;
...
(
    ...
    CONSTRAINT rent_person0_FK FOREIGN KEY (id_guarantor) REFERENCES person (id_person)
) ENGINE = InnoDB;
