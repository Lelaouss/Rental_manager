 ...
 * User
 *
 * @ORM\Table(name="user", uniqueConstraints={@ORM\UniqueConstraint(name="user_person_AK", columns={"id_person"})},
 *                         indexes={@ORM\Index(name="user_user_type0_FK", columns={"id_user_type"})})
